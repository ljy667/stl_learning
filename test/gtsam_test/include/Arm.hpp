...
public:
   ...
   **/
  void forwardKinematics(const gtsam::Vector& jp, std::optional<const gtsam::Vector&> jv,
      ...
      std::optional<std::vector<gtsam::Matrix>&> J_jvx_jv = std::nullopt) const override;
